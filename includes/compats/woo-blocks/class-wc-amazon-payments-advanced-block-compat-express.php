...
class WC_Amazon_Payments_Advanced_Block_Compat_Express extends WC_Amazon_Payments_Advanced_Block_Compat_Abstract {
	...
	public function get_payment_method_data() {
        ...
        return array(
            ...
            'selectedPaymentMethod' => $checkout_session ? esc_html( $wc_apa_gateway->get_selected_payment_label( $checkout_session ) ) : '',
            'hasPaymentPreferences' => $checkout_session ? $wc_apa_gateway->has_payment_preferences( $checkout_session ) : false,
