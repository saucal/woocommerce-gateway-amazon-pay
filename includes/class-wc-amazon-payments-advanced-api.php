...
class WC_Amazon_Payments_Advanced_API extends WC_Amazon_Payments_Advanced_API_Abstract {
	...
	/**
	 * Provides an easy way of invalidating the cached results of the range to wildcards algorithm.
	 * Failsafe in the case of spotted bugs.
	 */
	const RANGE_TO_WILDCARDS_ALGO_VERSION = 'v1';
