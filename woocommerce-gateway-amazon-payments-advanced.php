	...
	protected function get_admin_notices() {
		...
		if ( ! wc_checkout_is_https() ) {
			$notices[] = array(
				...
				'text'           => sprintf(
					/* translators: 1) The URL to the Amazon Pay settings screen. */
					__( '<p>Amazon Pay is enabled but a SSL certificate is not detected. Please ensure your server has a valid <a href="%1$s" target="_blank">SSL certificate</a> to get the plugin working properly.', 'woocommerce-gateway-stripe' ),
